...
<head>
  <title>Student | Grades | WJC</title>
  ...
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content">
        ...
        <h1>IMPORTANT PLEASE READ: <br> Grades reflected may not be the final grades for each class.</h1>
     ...
     <ul class="dropdown"> </ul>
        ...
        <select onchange="la(this.value)">
          ...
          <option value="MidTerm.php">Current report</option>
          <option value="StudentSub1">Assignment and Subject</option>
